 ...
 this.Sliding = false;
    ...
    if (this.Sliding) {
        this.World.AddSprite(new Mario.Sparkle(this.World, ((this.X + Math.random() * 4 - 2) | 0) + this.Facing * 8,
            ...
            var audio = new Audio('Mario Voice/Mario Ya.wav');
            audio.play();
        this.Ya *= 0.5;
    }
...
Mario.Character.prototype.GetHurt = function() {
    ...
    if (this.Large) {
        ...
        var audio = new Audio('Mario Voice/OW.wav');
        audio.play();
        this.Coins-= 10;
        if (this.Fire) {
...
Mario.Character.prototype.Win = function() {
    ...
    var audio = new Audio('Yay.wav');
            audio.play();
            var audio = new Audio('Mario Voice/mario_waytogo.wav');
            audio.play();
...
Mario.Character.prototype.Die = function() {
    ...
    var audio = document.getElementById("wtf");
    audio.volume = 0.0; audio.currentTime =0; 
    var audio = new Audio('Mario Voice/MARIO OWIE.wav');
    audio.play();
    var audio = document.getElementById("map");
    audio.volume = 0.0; audio.currentTime =0;
    var audio = document.getElementById("overworld");
...
Mario.Character.prototype.GetFlower = function() {
    ...
    if (!this.Fire) {
        ...
        audio.play();
        var audio = new Audio('Mario Voice/Got It.wav');
        audio.play();
...
Mario.Character.prototype.Kick = function(shell) {
    ...
    if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A)) {
        ...
        Enjine.Resources.PlaySound("powerup");
        this.SetLarge(true, true);
        var audio = new Audio('Mario Voice/mario-whatatastytreat.wav');
        audio.play();
        var audio = new Audio('Yay.wav');
        audio.play();
    } else {
...
Mario.Character.prototype.GetCoin = function() {
    ...
    if (this.Coins === 50) {
        ...
        this.GroundInertia = 0.89;
        this.AirInertia =  0.89;
        var audio = new Audio('Mario Voice/appeal.wav');
        audio.play();
        var audio = new Audio('Yay.wav');
        audio.play();
        this.SetLarge(true, false);
