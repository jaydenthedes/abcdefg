...
Mario.Character.prototype.Move = function() {
    ...
    if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A) && this.CanShoot && this.Fire && this.World.FireballsOnScreen < 2) {
        ...
        var audio = new Audio('sounds/BLASTER.WAV');
 audio.play();
 this.GroundInertia = 1.49;
 this.YJumpSpeed = -6.9;
 this.JumpTime = 7;
 this.Ya = this.JumpTime * this.YJumpSpeed;
 this.OnGround = false;
 this.Sliding = false;
    ...
    if (this.Sliding) {
        this.World.AddSprite(new Mario.Sparkle(this.World, ((this.X + Math.random() * 4 - 2) | 0) + this.Facing * 8,
            ...
            var audio = new Audio('Weegee Voice/Luigi Ho.wav');
            audio.play();
        this.Ya *= 0.5;
    }
    ...
    if (this.Large) {
        ...
        if (!this.OnGround) {
            if (this.Carried !== null) {
                ...
                var audio = new Audio('SMA4-PMeter1.wav');
                audio.play();
                runFrame = 7;
            } else {
        ...
        if (!this.OnGround) {
            if (this.Carried !== null) {
                ...
                var audio = new Audio('SMA4-PMeter2.wav');
                audio.play();
                runFrame = 5;
            } else {
...
Mario.Character.prototype.GetHurt = function() {
    ...
    if (this.Large) {
        ...
        var audio = new Audio('Weegee Voice/Luigi Hey.wav');
        audio.play();
        this.Coins-= 10;
        if (this.Fire) {
...
Mario.Character.prototype.Die = function() {
    ...
    var audio = new Audio('Weegee Voice/cry1.wav');
    audio.play();
    var audio = document.getElementById("map");
    audio.volume = 0.0; audio.currentTime =0;
    var audio = document.getElementById("overworld");
...
Mario.Character.prototype.GetFlower = function() {
    ...
    if (!this.Fire) {
        this.World.Paused = true;
        this.PowerUpTime = 18;
        var audio = new Audio('Mega Mushroom Powerup (NSMB, NSMB2, Mario Tennis Aces).wav');
        audio.play();
        var audio = new Audio('Weegee Voice/Got It.wav');
        audio.play();
...
Mario.Character.prototype.Kick = function(shell) {
    ...
    if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A)) {
        ...
        this.SetLarge(true, true);
        this.Coins = 0;
        var audio = new Audio('Weegee Voice/luigi-pieceofacake.wav');
        audio.play();
        var audio = new Audio('Yay.wav');
        audio.play();
    } else {
...
Mario.Character.prototype.GetCoin = function() {
    ...
    if (this.Coins === 50) {
        ...
        this.GroundInertia = 0.89;
        this.AirInertia =  0.89;
        var audio = new Audio('Weegee Voice/luigi_yayhay.wav');
        audio.play();
        var audio = new Audio('Yay.wav');
        audio.play();
        this.SetLarge(true, false);
