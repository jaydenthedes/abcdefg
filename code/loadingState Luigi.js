...
Mario.LoadingState.prototype.Enter = function() {
    ...
    this.Images[3].src = "images/racoonweegeesheet.png";
    this.Images[4].src = "images/font.gif";
    this.Images[5].src = "images/gameovergost.gif";
    this.Images[6].src = "images/itemsheet 2.png";
    this.Images[7].src = "images/logo.gif";
    this.Images[8].src = "images/mapsheet.png";
    this.Images[9].src = "images/weegeesheet.png";
    this.Images[10].src = "images/particlesheet.png";
    this.Images[11].src = "images/firemariosheet.png";
    this.Images[12].src = "images/smallluigisheet.png";
    this.Images[13].src = "Fox Luigi.png";
    this.Images[14].src = "images/worldmap Weegee.png";
    ...
    if (testAudio.canPlayType("audio/mp3")) {
    	Enjine.Resources.AddSound("1up", "sounds/1-up.wav", 1)
            ...
            .AddSound("coin", "Sonic the Hedgehog Coin Sound.wav", 5)
		    .AddSound("death", "Dead (Captain Toad Treasure Tracker, Super Mario Maker).wav", 1)
		    .AddSound("exit", "win.wav", 1)
            .AddSound("fireball", "sounds/BLASTER.WAV", 1)
		    .AddSound("jump", "sounds/jump.mp3")
		    .AddSound("kick", "sounds/kick.wav")
		    .AddSound("pipe", "sounds/pipe.mp3", 1)
		    .AddSound("powerdown", "ringless.wav", 1)
	    ...
	    Enjine.Resources.AddSound("1up", "sounds/1-up.wav", 1)
		    ...
		    .AddSound("coin", "sounds/nsmb_coin.wav", 5)
