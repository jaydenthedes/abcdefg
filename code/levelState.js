...
Mario.LevelState.prototype.Enter = function() {
    ...
    if (this.LevelType === Mario.LevelType.Overground) {
        ...
        var audio = new Audio('Mario Voice/Mario Here I Go.wav');
        audio.play();
} else if (this.LevelType === Mario.LevelType.Underground) {
    var audio = document.getElementById("underground");
    audio.volume = 1.0; audio.currentTime =0;         var audio = new Audio('Mario Voice/Mario Here I Go.wav');
    audio.play();
  ...
  var audio = new Audio('Mario Voice/Mario Here I Go.wav');
    ...
    for (i = 0; i < 2; i++) {
        ...
        h = ((((this.Level.Height * 16) - 150) / scrollSpeed) | 0) + 240;
        bgLevelGenerator = new Mario.BackgroundGenerator(w / 12 + 1, h / 32 + 1, i === 0, this.LevelType);
...
Mario.LevelState.prototype.Draw = function(context) {
    ...
    this.DrawStringShadow(context, "MARIO'S", 0, 0);
    this.DrawStringShadow(context, "LIFE:" + Mario.MarioCharacter.Lives, 0, 1);
    this.DrawStringShadow(context, "GOLD", 14, 0);
    this.DrawStringShadow(context, " " + Mario.MarioCharacter.Coins, 14, 1);
    this.DrawStringShadow(context, "DJ STUDIO", 20, 0);
    this.DrawStringShadow(context, ""  + Mario.MarioCharacter.LevelString, 20, 1);
    this.DrawStringShadow(context, "DEATH", 33, 0);
