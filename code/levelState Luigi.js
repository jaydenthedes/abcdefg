...
Mario.LevelState.prototype.Enter = function() {
    ...
    if (this.LevelType === Mario.LevelType.Overground) {
        ...
        audio.volume = 1.0; audio.currentTime =0;         var audio = new Audio('Weegee Voice/Lets A Do It.wav');
        audio.play();
    ...
    audio.play();
        ...
        var audio = new Audio('Weegee Voice/Lets A Do It.wav');
    audio.play();
}
...
Mario.LevelState.prototype.Draw = function(context) {
    ...
    this.DrawStringShadow(context, "LUIGI'S", 0, 0);
