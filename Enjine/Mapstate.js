...
Mario.MapState.prototype.Enter = function() {
    ...
    this.Font = Mario.SpriteCuts.CreateGreemFont();
            ...
            if (this.Level[x][y] === Mario.MapTile.Level && this.Data[x][y] !== -11) {
                if (this.Level[x][y] === Mario.MapTile.Level && this.Data[x][y] !== 0 && this.Data[x][y] > -10) {
                    ...
                    if (this.Data[x][y] < 0) {
                        if (this.Data[x][y] === 0) {
                            difficulty = 10;
                            Mario.MarioCharacter.LevelString = "THE GOOD FIGHT";
                          
                        } else if (this.Data[x][y] === -1) {
                            difficulty += 8;
                            Mario.MarioCharacter.LevelString = "DARK SIDE";
...
Mario.MapState.prototype.Draw = function(context) {
    ...
    this.Font.Strings[0] = { String: "LUIGI's LIFE: " + Mario.MarioCharacter.Lives, X: 4, Y: 4 };
    this.FontShadow.Strings[0] = { String: "LUIGI'S LIFE: " + Mario.MarioCharacter.Lives, X: 5, Y: 5 };
